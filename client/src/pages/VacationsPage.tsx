...
export default function VacationsPage() {
  ...
  const handleModalSuccess = () => {
    // mutations invalidate and refetch automatically
  };
      ...
      <div className="bg-white rounded-lg shadow">
        {isLoading ? (
          <div className="p-8 text-center">
            ...
            <p className="mt-2 text-gray-600">Carregando férias...</p>
          </div>
        ) : vacations.length === 0 ? (
          <div className="p-8 text-center">
                  ...
                  <tr key={vacation.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">
                        {formatDate(vacation.startDate)} a{" "}
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  Tem certeza que deseja excluir este período de
                                  férias? Esta ação não pode ser desfeita.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
